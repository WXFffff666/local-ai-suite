 ...
 */
export const galleryReadImageSchema = z.object({
  id: z.string().min(1).max(256),
  kind: z.enum(['thumb', 'original']).default('thumb')
})
export type GalleryReadImageInput = z.infer<typeof galleryReadImageSchema>
